...
class _SellerScreenState extends State<SellerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Seller Form', style: TextStyle(color: Colors.black, fontSize: 22),),
        centerTitle: true,
        backgroundColor: appBarColor,
        shadowColor: Colors.white10,
      ),
      body: isCompleted? buildCompleted():
      Theme(data: ThemeData(primaryColor: Colors.white10, primarySwatch: Colors.green, shadowColor: Colors.white10),
        child: Stepper( 
  ...
  buildCompleted(){
    return Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center,
        ...
        Text("Done !", style:  TextStyle(fontSize: 32,),),
              
        Padding(
          padding: const EdgeInsets.only(left: 80, right: 80),
          child: ElevatedButton(style: ElevatedButton.styleFrom(
            primary: Colors.green,
            textStyle: TextStyle(fontSize: 22), minimumSize: Size.fromHeight(35),
          ),
          child: Text('Reset'),
          onPressed: ()=> setState(() {
            isCompleted= false;
  ...
  List<Step> getSteps()=> [
    Step(title: Text('Seller Info'),
     content: sellerData(),
     isActive: currentStep >=0,
     state: currentStep >0 ? StepState.complete: StepState.indexed ),
    Step(title: Text('Property Details'), content: proprtyInfo(),
    ...
    return Container(
            ...
            child:Form( key: RIKeys.riKey4, child: SingleChildScrollView( child: Column(children: [
              ...
              controller: Address,
               ...
               TextFormField( cursorColor:greenO ,controller: City, readOnly: true,
              ...
              decoration: InputDecoration(labelText: 'Bedrooms', labelStyle: TextStyle(color: greenO, fontSize: 12 )),),
              TextField( cursorColor:greenO ,
              controller: Bathrooms,
              keyboardType: TextInputType.number,
              decoration: InputDecoration(labelText: 'Bathrooms', labelStyle: TextStyle(color: greenO, fontSize: 12 )),),
              TextField( cursorColor:greenO ,
              controller: Price,
              keyboardType: TextInputType.number,
               decoration: InputDecoration( labelText: 'Price', labelStyle: TextStyle(color: greenO, fontSize: 12 )),),
